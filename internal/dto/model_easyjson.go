...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto2(in *jlexer.Lexer, out *URLs) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto2(out *jwriter.Writer, in URLs) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto3(in *jlexer.Lexer, out *ShorteningList) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto3(out *jwriter.Writer, in ShorteningList) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto4(in *jlexer.Lexer, out *Shortening) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto4(out *jwriter.Writer, in Shortening) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto5(in *jlexer.Lexer, out *ShortenOutput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto5(out *jwriter.Writer, in ShortenOutput) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto6(in *jlexer.Lexer, out *ShortenListOutputLine) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto6(out *jwriter.Writer, in ShortenListOutputLine) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto7(in *jlexer.Lexer, out *ShortenListOutput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto7(out *jwriter.Writer, in ShortenListOutput) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto8(in *jlexer.Lexer, out *ShortenListInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
		...
		for !in.IsDelim(']') {
			...
			easyjsonC80ae7adDecode2(in, &v13)
			*out = append(*out, v13)
			in.WantComma()
		}
		in.Delim(']')
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto8(out *jwriter.Writer, in ShortenListInput) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
		for v14, v15 := range in {
			...
			easyjsonC80ae7adEncode2(out, v15)
		}
		out.RawByte(']')
	}
}
...
func easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto9(in *jlexer.Lexer, out *ShortenInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto9(out *jwriter.Writer, in ShortenInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ShortenInput) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC80ae7adEncodeGithubComAjugalushkinUrlShortenerVersion2InternalDto9(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *ShortenInput) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto9(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ShortenInput) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC80ae7adDecodeGithubComAjugalushkinUrlShortenerVersion2InternalDto9(l, v)
}
